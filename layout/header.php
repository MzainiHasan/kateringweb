    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-blue">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="#">Mz Hasan</a>
        </div>
        ...
        <!-- Wrapper for Slides -->
          <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('<?php $url ?>assets/img/food.png');"></div>
            ...
            <div class="item">
                ...
                <div class="fill" style="background-image:url('<?php $url ?>assets/img/food2.png');"></div>
                <div class="carousel-caption">
                    <h3> PT Mulia Jaya Sejahtera adalah salah satu katering makanan terbaik yang ada dibalikpapan tepatnya di perumahan regency. rasa, khas dan bahan yang asli dari tanah air indonesia , Disini anda dapat memesan langsung dengan mudah dengan pelayanan prima kami dan layanan kami 24 jam , jadi kapanpun anda dapat memesan dari sini</h3>
                </div>
            </div> 
        </div>
   ...
   <?php } ?>
	...
	<div class="row">
		<div class="col-md-3">
			...
			<div class="row col-md-12">
				<hr>
				<img src="<?php echo $url.'assets/img/food.png'; ?>" width="100%"><br><br>
				<img src="<?php echo $url.'assets/img/food2.png'; ?>" width="100%">
			</div>
		</div>